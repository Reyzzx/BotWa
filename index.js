...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Vinzx) ]')}\n\n${chalk.red('SNEAZY')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Instagram')} : ${chalk.white('@ardynvyn__')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 857-3241-5700')}\n${chalk.red('Donate')} : ${chalk.white('083870705906 ( Gopay/dana/Pulsa )')}\n`))
}
